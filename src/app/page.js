  ...
  return (
    <div className="bg-gradient-to-b from-gray-900 to-black min-h-screen text-white font-sans">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 p-8">
        ...
        {/* About Section */}
        <div className="flex items-center justify-center bg-gradient-to-r from-green-300 via-green-400 to-green-600 rounded-2xl p-10 w-44 h-44 text-center hover:scale-105 transition-transform duration-300 shadow-lg -my-56 mx-96">
        ...
        {/* Image Section */}
        <div className="relative rounded-2xl hover:scale-105 transition-transform duration-300 shadow-lg overflow-hidden w-80 h-44 -my-60 mx-44">
          <Image
        ...
        {/* Resources Section */}
        <div className="bg-gradient-to-r from-green-300 via-green-400 to-green-600 rounded-2xl p-10 flex flex-col justify-between h-96 w-96 hover:scale-105 transition-transform duration-300 shadow-lg cursor-pointer mx-8 -my-60">
        ...
        <div className="col-span-1 bg-gradient-to-r from-green-300 via-green-400 to-green-600 rounded-2xl p-10 flex flex-col items-center transition-transform transform hover:scale-105 shadow-lg h-44 -my-16">
        ...
        {/* Stack Section */}
        <div className="col-span-1 bg-gradient-to-r from-green-300 via-green-400 to-green-600 rounded-2xl p-10 flex flex-col items-center gap-6 hover:scale-105 transition-transform duration-300 shadow-lg h-44 -my-16">
